...
const sheetVariants = cva(
	"ease fixed z-50 gap-4 bg-background p-6 shadow-lg transition data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:duration-250 data-[state=open]:duration-250",
	{
		variants: {
			side: {
