...
const EditableShortcutKey = ({
	...
	return (
		<kbd
			className={`mr-1 inline-flex min-h-[1.5rem] min-w-[1.5rem] cursor-pointer items-center justify-center rounded border px-2 font-sans text-xs leading-none shadow-sm hover:bg-opacity-80 ${
				isRecording
	...
	return (
		<Dialog onOpenChange={setOpen} open={open}>
			<DialogTrigger asChild>
				<Button className="gap-2" size="sm" variant="text">
